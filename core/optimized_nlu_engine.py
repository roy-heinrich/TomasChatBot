...
class OptimizedNLUEngine(NLUEngine):
    ...
    def _compile_patterns(self):
        ...
        self.compiled_patterns = {
            ...
            'greeting_patterns': re.compile(r'\b(?:h+i+|h+e+l+l+o+|h+e+y+|good morning|good afternoon|good evening|good day|good night|greetings|kumusta|kamusta|magandang umaga|magandang hapon|magandang gabi|maayong aga|maayong hapon|maayong gab-i|magandang araw|maayong adlaw|maayong gabii|maayong buntag|hiya|howdy|wassup|what\'s up|yo|hey there|hello there|hi there|morning|afternoon|evening|night)\b', re.IGNORECASE),
